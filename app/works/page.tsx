  ...
  export default function Home() {
    return (
      ...
      {/* =========================================
        ...
        ========================================= */}
        {/* py-40 を pt-40 pb-20 に変更し、下側の巨大なデッドスペースを構造から削減 */}
        <section id="contact" className="relative w-full pt-40 pb-20 px-6 flex flex-col items-center justify-center bg-black border-t border-white/10 overflow-hidden">
        ...
        {/* =========================================
            06. Footer (Unified & Refactored)
        ========================================= */}
        {/* 重複を削除し「group」を付与。pt-12で上のボタンとの距離を黄金比に締める */}
        <footer className="w-full bg-black pt-12 pb-12 px-8 border-t border-gray-900/50 group">
          <div className="flex flex-col items-center justify-center gap-4">
            <div className="text-center">
              {/* 通常時は黒潰れしない「明瞭で美しいグレー(opacity-70)」。ホバーで100%のグリーンと鮮烈なネオン後光が覚醒 */}
              <img 
                src="/noirlogo.png" 
                alt="Tech Noir Logo" 
                className="h-12 w-auto mx-auto mb-2 grayscale opacity-70 transition-all duration-700 ease-out group-hover:grayscale-0 group-hover:opacity-100 group-hover:drop-shadow-[0_0_15px_rgba(45,212,191,0.6)]" 
              />
            ...
            <div className="text-gray-800 text-[10px] tracking-[0.2em]">
